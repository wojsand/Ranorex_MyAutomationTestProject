...
chmod u+x apache-tomcat-7.0.68/bin/*.sh
...
"$RUNJAVA" -cp hsqldb/lib/hsqldb.jar org.hsqldb.Server -database.0 hsqldb/data/iteraplan -dbname.0 iteraplan > hsqldb.out &
apache-tomcat-7.0.68/bin/catalina.sh start
