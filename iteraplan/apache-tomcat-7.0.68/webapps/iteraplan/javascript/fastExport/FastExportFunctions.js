	...
	function getResultFormatOptionPreviewDownload() {
		if (globalDiagramType == 'ContextOverviewDiagram') {
			return getResultFormatOption('resultFormatDropdown2');
		} else {
	...
	function showDownloadButton() {
		...
		if(globalDiagramType!='NeighborhoodDiagram' && globalDiagramType!='ContextOverviewDiagram'){
	...
	function toggleVisioExportFormat(){
		if(globalDiagramType == 'ContextOverviewDiagram'){
			// resultFormatDropdown2 without Visio-Option will be displayed
			$('#resultFormatDropdown').css('display', 'none');
			$('#resultFormatDropdown2').css('display', '');					
		}
		else{
			// standard resultFormatDropdown will be displayed
			$('#resultFormatDropdown').css('display', '');
			$('#resultFormatDropdown2').css('display', 'none');
		}
	}
	...
	function clickContextOverview(key) {
		clickAction("ContextOverviewDiagram"); 
		refreshHeader(key);
	}