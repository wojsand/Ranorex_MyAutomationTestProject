...
<tilesx:useAttribute name="collapse" />
...
<itera:message var="firstBBT" key="${componentModel.firstType}"/>
<itera:message var="columnBBT" key="${componentModel.columnType}"/>
<itera:message var="rowBBT" key="${componentModel.rowType}"/>
<itera:message var="contentBBT" key="${componentModel.contentType}"/>
	...
	<div class="accordion-group">
		<div class="accordion-heading">
			<a class="accordion-toggle" data-toggle="collapse" data-parent="#businessMapping_accordion" href="#businessMapping_settings"
				...
				<itera:message key="businessMapping.settingsHeader" />
			</a>
		</div>
				    ...
				    <tr>
						<td width="200" height="200"> 
							...
							<form:select path="${path_to_componentModel}.selectedBbId" onchange="flowAction('changeSettings');">
						  		<form:option value="-1"> &lt;<itera:message key="reports.selectAll" />&gt; </form:option>
							...
							<c:if test="${componentModel.selectedBbId != null && componentModel.selectedBbId >= 0}">
						  		<input id="transactionShowBusinessMappings" type="button" class="btn" onclick="flowAction('sendBMRequest');" value="<itera:message key="businessMapping.sendRequest" />" />		
							</c:if>
				      	</td>
				      	<td>
