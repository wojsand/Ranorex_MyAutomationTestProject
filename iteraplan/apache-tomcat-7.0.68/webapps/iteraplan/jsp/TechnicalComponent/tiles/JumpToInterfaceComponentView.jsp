...
<div id="JumpToInterfaceComponentViewModule" class="row-fluid module">
	<div class="module-heading">
		<itera:message key="technicalComponentRelease.to.informationSystemInterfaces" />
	</div>
	<div class="row-fluid">
			...
			<div class="row-fluid">
				<table class="table table-striped table-condensed tableInModule">
					...
					<c:if test="${componentMode == 'CREATE'}">
						<tr>
							<td colspan="4" class="errorHeader"><itera:message key="technicalComponentRelease.choose.interface" /></td>
						</tr>
					</c:if>
					<thead>
						<c:choose>
							...
							<c:otherwise>
								<tr>
									...
									<th><itera:message key="informationSystemRelease.interfaceTo" />&nbsp;</th>
									<th><itera:message key="global.direction" />&nbsp;</th>
									<th><itera:message key="informationSystemRelease.interfaceTo" />&nbsp;</th>
								</tr>
							</c:otherwise>
						</c:choose>
							...
							<tr id="<c:out value="${html_id}_new" />">
								<td colspan="4">
									<a href="#" rel="tooltip" data-original-title="Hotkey: <img/> <itera:message key="jumpToInterface.tooltip"/>">
										<input type="button" class="link btn" value="<itera:message key="button.chooseConn" />" 
