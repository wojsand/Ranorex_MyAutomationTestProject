...
<tilesx:useAttribute name="searchFormIdToUse" />
<tilesx:useAttribute name="filterInputId" />
<tilesx:useAttribute name="tableToFilterId" />
...
<div id="${searchFormIdToUse}" class="pull-right">
	...
	<a id="removeFilter" class="link" title="<itera:message key="global.filter.clear"/>" 
