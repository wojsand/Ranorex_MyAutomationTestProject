...
<h1><itera:message key="reports.filterFor"/>&nbsp;<itera:message key="${memBean.reportResultType.typeNamePluralPresentationKey}" /></h1>
<br/>
<br/>
...
<div class="ReportingRequestButtons">
	<a href="#" rel="tooltip" data-original-title="Hotkey: <img/> <itera:message key='button.sendQuery.tooltip'/>">
		<input onclick="flowAction('requestReport');" type="button" id="sendQueryButton" class="link btn" value="<itera:message key="button.sendQuery" />"/>
	</a>
	<a href="#" rel="tooltip" data-original-title="Hotkey: <img/> <itera:message key='button.resetReport.tooltip'/>">
		<input onclick="flowAction('resetReport');" type="button" id="buttonResetReport" class="link btn" value="<itera:message key="button.reset" />"/>
	</a>
	<input type="button" class="link btn btn-primary" id="buttonSendAndConfirm" value="<itera:message key="global.requestAndConfirmSelection" />" onclick="flowAction('requestAndConfirmReport');" />
	<c:if test="${not empty memBean.results}">
	    ...
	    <a href="#" rel="tooltip" data-original-title="Hotkey: <img/> <itera:message key='button.confirmSelection.tooltip'/>">
			<input onclick="flowAction('resumeFromFilter');" type="button" id="buttonConfirmSelection" class="link btn" value="<itera:message key="global.confirmSelection" />"/>
		</a>
	</c:if>
</div>
