...
<div id="HeaderContainer" class="row-fluid module">
	...
	<div class="row-fluid">
		<div class="module-body">
			<div class="row-fluid">
				<itera:message key="${selectInstances_key}" />&nbsp;	
				<c:choose>
	...
	<c:if test="${not empty memBean.results && massUpdateMode == true}">
		<div class="ReportingRequestButtons btn-toolbar">
			<div id="massUpdate_moreOptions" class="btn-group" >
				...
				<input name="prepareForMassUpdate" class="btn" onclick="flowAction('prepareForMassUpdate')" type="button" value="<itera:message key="massUpdates.requestMassUpdate" />"/>
				
				<c:if test="${memBean.massUpdateType.typeOfBuildingBlock.value != 'businessMapping.singular'}">
				
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#" >
						<itera:message key="massUpdates.moreOptions" />
					...
					<ul class="dropdown-menu dropdown-right">
						<li>
				   			<a id="massDelete" href="#"
				   				...
				   				<itera:message key="massUpdates.requestMassDelete" />
				   			</a>
				   		</li>
				   		<c:if test="${not empty userContext.user.email}">
					   		<li>
					   			<a id="massSubscribe" href="#"
					   				...
					   				<itera:message key="massUpdates.requestMassSubscribe" />
					   			</a>
					   		</li>
					   		<li>
					   			<a id="massUnsubscribe" href="#"
					   				onclick="flowAction('massUnsubscribe')" >
					   				<itera:message key="massUpdates.requestMassUnsubscribe" />
					   			</a>
					   		</li>
				   		</c:if>
					</ul>
