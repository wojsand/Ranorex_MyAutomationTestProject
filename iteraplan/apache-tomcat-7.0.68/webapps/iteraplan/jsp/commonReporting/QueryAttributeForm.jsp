...
<c:forEach items="${queryFirstLevelsArray}" var="firstLevel" varStatus="countFirstLevelStatus">
	...
	<c:if test="${countFirstLevel >= 1}">
		<tr>
			<td colspan="3"><b><itera:message key="reports.and" /></b></td>
		</tr>
	</c:if>
					                	...
					                	<c:otherwise>
					                  		...
					                  		<td colspan="5">
					                  			<c:set var="orButtonTooltip">
					                        			<itera:message key="reports.addAlternative" />
					                      			</c:set>
					                      			<c:set var="imageOrURL">
					                        			<itera:message key="image.orButton" />
					                      			</c:set>
...
<div class="row-fluid">
	<c:set var="andButtonTooltip">
		<itera:message key="reports.addAnd" />
	</c:set>
	<c:set var="imageAndURL">
		<itera:message key="image.andButton" />
	</c:set>
