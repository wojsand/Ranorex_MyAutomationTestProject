...
<tilesx:useAttribute name="countFirstLevel" ignore="true" />
<tilesx:useAttribute name="countSecondLevel" ignore="true" />
<tilesx:useAttribute name="countSecondLevelBlocks" ignore="true" />
<tilesx:useAttribute name="affectedQueryFormIdJavaScript" ignore="true" />
<tilesx:useAttribute name="affectedSecondLevelQueryFormIdJavaScript" ignore="true" />
<tilesx:useAttribute name="pathToQPart" />
<tilesx:useAttribute name="idSuffix" />
<tilesx:useAttribute name="availableAttributes" />
<tilesx:useAttribute name="availableAttributeValuesResolver" />
	...
	<td>
		<c:if test="${not empty affectedQueryFormIdJavaScript}">
			<a class="link" href="#"
				...
				title="<itera:message key="reports.removeCondition"/>"
...
<tr>
	<c:choose>
		<c:when test="${countSecondLevel < (countSecondLevelBlocks-1)}">
			<td rowspan="2" colspan="2"><b><itera:message key="reports.or" /></b></td>
		</c:when>
		<c:otherwise>
			<td colspan="2">&nbsp;</td>
		</c:otherwise>
	...
	<td>
      <c:set var="calendarDisabled">
		<itera:write name="memBean"	property="${pathToQPart}.dateATSelected" escapeXml="false" />
      </c:set>
      <c:set var="isNumberAT">
		<itera:write name="memBean"	property="${pathToQPart}.numberATSelected" escapeXml="false" />
      </c:set>
	...
	<c:if test="${calendarDisabled}">
		...
		<td><a
			...
			class="link" title="<itera:message key="global.date.remove"/>"
