...
<tilesx:useAttribute name="relationLabelKey" />

<%-- The EL expression to retrieve the added elements from bbChangeset --%>
<tilesx:useAttribute name="addedElementsPath" />
...
<tilesx:useAttribute name="removedElementsPath" />
...
<%-- TODO: convert table into module --%>
	<table class="elementComponentView table table-bordered table-striped table-condensed">
		<thead>
		  <tr>
			<th>
				<itera:message key="${relationLabelKey}"/> 
			</th>
		  </tr>
		</thead>
		<tbody>
