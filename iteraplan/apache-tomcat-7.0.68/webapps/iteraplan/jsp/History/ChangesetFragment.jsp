			...
			<div class="row-fluid">
				<c:choose>
					...
					<c:when test="${bbChangeset.initialChangeset}">
						<itera:message key="history.initialrevision" />
					</c:when>
					...
					<c:when
						...
						<itera:message key="history.noKnownChanges" />
					</c:when>
					...
					<c:otherwise>
										...
										<div class="row-fluid">
											<table
												...
												<thead>
													<tr>
														<th></th>
														<th><itera:message key="history.from" /></th>
														<th><itera:message key="history.to" /></th>
													</tr>
												</thead>
												<tbody>
													<c:if test="${bbChangeset.nameChanged}">
														<tr>
															<td><b><itera:message key="global.name" /></b></td>
													...
													<c:if test="${bbChangeset.descriptionChanged}">
														<tr>
															<td><b><itera:message key="global.description" /></b></td>
													...
													<c:if
														...
														<tr>
															<td><b><itera:message key="global.productive_from" /></b></td>
															<td><c:out
														...
														<tr>
															<td><b><itera:message key="global.productive_to" /></b></td>
															<td><c:out
													...
													<c:if test="${bbChangeset.typeOfBuildingBlock == 'INFORMATIONSYSTEMINTERFACE' && (bbChangeset.addedInformationSystemA != null || bbChangeset.removedInformationSystemA != null)}">
	    											    <tr>
	            											<td><b><itera:message key="interface.releaseA"/></b></td>
	        												<td><c:out value="${bbChangeset.removedInformationSystemA}" /></td>
	           												<td><c:out value="${bbChangeset.addedInformationSystemA}" /></td>
	      											 	</tr>
	    											</c:if>

	    											<c:if test="${bbChangeset.typeOfBuildingBlock == 'INFORMATIONSYSTEMINTERFACE' && (bbChangeset.addedInformationSystemB != null || bbChangeset.removedInformationSystemB != null)}">
	    												<tr>
	        												<td><b><itera:message key="interface.releaseB"/></b></td>
	        												<td><c:out value="${bbChangeset.removedInformationSystemB}" /></td>
	           												<td><c:out value="${bbChangeset.addedInformationSystemB}" /></td>
	       												</tr>
	    											</c:if>
													...
													<c:if
														...
														<tr>
															<td><b><itera:message key="global.type_of_status" /></b></td>
															<td><itera:message key="${bbChangeset.statusFrom}" /></td>
															<td><itera:message key="${bbChangeset.statusTo}" /></td>
														</tr>
													</c:if>
						...
						<c:if test="${bbChangeset.relationsChanged}">
							<c:choose>
								...
								<c:when test="${bbChangeset.typeOfBuildingBlock == 'ITSERVICE'}">
									<tiles:insertTemplate
										template="/jsp/History/ITServiceRelations.jsp">
										<tiles:putAttribute name="bbChangeset" value="${bbChangeset}" />
									</tiles:insertTemplate>
								</c:when>
							</c:choose>
