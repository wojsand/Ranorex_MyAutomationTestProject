...
<tiles:insertTemplate template="/jsp/History/ManyAssociationSetFragment.jsp">
	...
	<tiles:putAttribute name="relationLabelKey" value="businessUnit.to.businessDomains" />
...
<tiles:insertTemplate template="/jsp/History/ManyAssociationSetFragment.jsp">
	<tiles:putAttribute name="bbChangeset" value="${bbChangeset}" />
	<tiles:putAttribute name="relationLabelKey" value="businessUnit.to.businessMappings" />
...
<tiles:insertTemplate template="/jsp/History/ManyAssociationSetFragment.jsp">
    <tiles:putAttribute name="bbChangeset" value="${bbChangeset}" />
    <tiles:putAttribute name="relationLabelKey" value="businessUnit.to.projects" />
