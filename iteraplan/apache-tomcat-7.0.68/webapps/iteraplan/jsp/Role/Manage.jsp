...
<div class="${componentModeClass}">
	<c:choose>
		<c:when test="${functionalPermission == true}">
			...
			<p>
			  <itera:message key="manageRoles.iturm.Roles"/>
			  	<a style="cursor:help;" href="<itera:message key="global.iturm.Link"/>">
			  		<itera:message key="global.iturm"/>
			  	</a>
			  <itera:message key="manageRoles.iturm.Roles2"/>
			</p>
