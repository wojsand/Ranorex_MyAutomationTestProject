...
<div id="ChooseTypeOfNewModul" class="row-fluid module">
	<div class="module-heading">
		<itera:message key="manageAttributes.chooseNewTypeHeader" />
	</div>
	<div class="row-fluid">
		<div class="module-body">
			<div class="row-fluid">
				<itera:message key="manageAttributes.chooseNewTypeInfo" />.
				<br/>
				<div class="control-group">
					...
					<label class="control-label-right" for="attributeTypeEnum_radio">
				  		<itera:message key="attribute.type.enum" />
				  	</label>
				</div>
				<div class="control-group">
					<div class="controls">
					...
					<label class="control-label-right" for="attributeTypeNumber_radio">
				  		<itera:message key="attribute.type.number" />
				  	</label>
				</div>
				<div class="control-group">
					<div class="controls">
					...
					<label class="control-label-right" for="attributeTypeText_radio">
				  		<itera:message key="attribute.type.text" />
				  	</label>
				</div>
				<div class="control-group">
					<div class="controls">
					...
					<label class="control-label-right" for="attributeTypeDate_radio">
				  		<itera:message key="attribute.type.date" />
				  	</label>
				</div>
				<div class="control-group">
					<div class="controls">
					...
					<label class="control-label-right" for="attributeTypeResponsibility_radio">
				  		<itera:message key="attribute.type.responsibility" />
				  	</label>
				</div>
				<div class="button-group">
					<input type="button" value="<itera:message key="global.back" />" onclick="flowAction('cancel');" class="btn" />
	        		<input type="button" value="<itera:message key="global.forward" />" onclick="flowAction('create');" class="btn" />
				</div>
			</div>
		</div>
	</div>
