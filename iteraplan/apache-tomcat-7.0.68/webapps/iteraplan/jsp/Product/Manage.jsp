	...
	<c:choose>
		<c:when test="${functionalPermission == true}">
			...
			<tiles:insertTemplate template="/jsp/common/TransactionBar.jsp" >
				...
				<tiles:putAttribute name="service_class" value="ProductService" />
			...
			<tiles:insertTemplate template="/jsp/common/ElementNameComponentView.jsp" flush="true">
				<tiles:putAttribute name="icon_suffix" value="product" />
			...
			<itera:tabgroup id="ConfigTabs" activeTab="${activeTab}">
			  	...
			  	<itera:tab id="TabAssignments" 	textKey="button.assignments" 	page="/jsp/Product/tabPages/TabAssignments.jsp" showTab="${showTab}"/>
			  	...
			  	<c:if test="${componentMode == 'READ'}">
			  		<itera:tab id="FastExport"  textKey="global.fastExport" 	page="/jsp/Product/tabPages/TabFastExportProduct.jsp" />
			  	</c:if>
				<c:if test="${componentMode == 'READ' && isHistoryEnabled}">
					<itera:tab id="TabLocalHistory" textKey="global.history"    page="/jsp/Product/tabPages/TabHistory.jsp"/>
				</c:if> 
			</itera:tabgroup>
