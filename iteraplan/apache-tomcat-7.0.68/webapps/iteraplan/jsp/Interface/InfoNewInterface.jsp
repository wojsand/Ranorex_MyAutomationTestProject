			...
			<div class="row-fluid">
				<table class="table table-striped table-condensed tableInModule">
					<thead>
						...
						<tr> 
							<th class="col-interface-name" nowrap="nowrap"><itera:message key="interface.releaseA" />:</th>
							...
							<th class="col-interface-name" nowrap="nowrap"><itera:message key="interface.releaseB" />:</th>
						</tr>
					</thead>
					<tbody>
						<%-- Connection --%>
						...
						<tr>
							<td class="top margin borderBottom">
								<div style="margin-bottom: 1em;">
									<itera:message key="global.description" />:<br />
									<div class="border">
