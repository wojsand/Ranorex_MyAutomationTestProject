...
<tilesx:useAttribute name="disallowElementDeletion" ignore="true"/>
...
--%>
<tilesx:useAttribute name="available_elements_field_style" ignore="true" />
						      		...
						      		<thead>
						        		<tr>
						          			...
						          			<c:forEach items="${column_header_keys}" var="key">
						            			<th><itera:message key="${key}" /></th>
						          			</c:forEach>
						          			<th><itera:message key="global.order" /></th>         
						        		</tr>
						        	</thead>
						      	</c:if>
						        		...
						        		<tr>
						          			...
						          			<td>
									        	<img src="<c:url value="/images/SortArrowTop.gif" />" 
									              ...
									              alt="<itera:message key="tooltip.moveTop" />"
									            ...
									            <img src="<c:url value="/images/SortArrowDown.gif"/>" 
									              ...
									              alt="<itera:message key="tooltip.moveDown"/>" 
									            ...
									            <img src="<c:url value="/images/SortArrowBottom.gif"/>" 
									              ...
									              alt="<itera:message key="tooltip.moveBottom"/>" 
					    	...
					    	<c:otherwise>
					      		<c:choose>
					        		...
					        		<c:otherwise>
					        			<thead>
						          			<tr>
						            			<th class="col-ico"><itera:message key="global.number" /></th>
						            			<c:forEach items="${column_header_keys}" var="key">
						              				<th><itera:message key="${key}" /></th>
						            			</c:forEach>
						            			<th>&nbsp;</th>
						...
						<c:if test="${component_mode != 'READ'}" >
		    				...
		    				<tr>
								<td></td>
								   	<td>
								   	  <label class="radio">
								     	<itera:message key="manageAttributes.enum.sortOrder.ascending" var="sortOrderAscLabel"/>
								     	<form:radiobutton path="${sort_field}" value="asc" label="${sortOrderAscLabel}"/>
						              </label>
								      <label class="radio">
								    	<itera:message key="manageAttributes.enum.sortOrder.descending" var="sortOrderDescLabel"/>
								    	<form:radiobutton path="${sort_field}" value="desc" label="${sortOrderDescLabel}"/>
								      </label>
									</td>
								 	<td>
								 		<input type="button" id="${html_id}_sortButton" name="sortButton" value="<itera:message key="button.sort" />" 
