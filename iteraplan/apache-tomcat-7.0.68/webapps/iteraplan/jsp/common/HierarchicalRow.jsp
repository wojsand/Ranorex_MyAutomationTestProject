...
<tilesx:useAttribute name="hierarchicalEntityNode" />
<tilesx:useAttribute name="resultColumnDefinitions" />
<tilesx:useAttribute name="addManageShortcuts" />
<tilesx:useAttribute name="hasPermissionForActions" />
      ...
      <td><c:if
          ...
          <c:if test="${updatePermissionType}">
            <a
              ...
              title="<itera:message key="button.edit" />"> <i
              class="icon-pencil"></i>
            </a>
          </c:if>
          <c:if test="${createPermissionType}">
            <a
              ...
              title="<itera:message key="button.copy" />"> <i
              class="icon-share"></i>
            </a>
          </c:if>
          <c:if test="${deletePermissionType}">
            <a
              ...
              title="<itera:message key="button.delete" />"> <i
              class="icon-trash"></i>
            </a>
          </c:if>
        </c:if></td>
