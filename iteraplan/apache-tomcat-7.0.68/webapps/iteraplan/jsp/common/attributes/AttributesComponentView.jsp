...
<tilesx:useAttribute name="path_to_componentModel" ignore="true" />
							...
							<div id="MainAttributesModule" class="row-fluid module" style="border:0;">
								<div class="row-fluid">
									...
									<c:if test="${componentMode != 'READ' && !writePermissionATG}">
										<div class="row-fluid">
											<div class="helpText"><itera:message key="messages.noAtGroupWritePermission" /></div>
										</div>
									</c:if>
