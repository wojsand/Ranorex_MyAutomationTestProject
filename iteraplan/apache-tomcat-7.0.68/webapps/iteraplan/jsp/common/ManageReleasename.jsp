...
<tilesx:useAttribute name="overviewMode" />
<tilesx:useAttribute name="element_html_id" ignore="true" />
<tilesx:useAttribute name="release_html_id" ignore="true" />
...
<c:choose>
	<c:when test="${(componentMode == 'EDIT' || componentMode == 'CREATE') && overviewMode}">
		...
		<div class="control-group">
	    	...
	    	<div class="controls">
				<span rel="tooltip" title="<itera:message key="global.release_name" />">
