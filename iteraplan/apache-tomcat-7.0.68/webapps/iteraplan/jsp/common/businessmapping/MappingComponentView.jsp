		...
		<div class="module-body">
			<div class="row-fluid">
				<c:if test="${(component_mode == 'EDIT' || component_mode == 'CREATE') && updatePermission == false}">
					<div class="helpText"><itera:message key="messages.noBmUpdatePermission" /></div>
				</c:if>
				<c:if test="${(component_mode == 'EDIT' || component_mode == 'CREATE') && createPermission == false}">
					<div class="helpText"><itera:message key="messages.noBmCreatePermission" /></div>
				</c:if>
				<c:if test="${(component_mode == 'EDIT' || component_mode == 'CREATE') && deletePermission == false}">
					<div class="helpText"><itera:message key="messages.noBmDeletePermission" /></div>	
				</c:if>
