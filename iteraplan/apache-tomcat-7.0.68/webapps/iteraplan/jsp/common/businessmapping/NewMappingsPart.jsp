...
<c:set var="typeOfBuildingBlock" value="${memBean.componentModel.typePresentationKey}" />
...
<div id="<c:out value="${html_id}_newBmForm"/>_Modul" class="row-fluid inner-module">
	<div class="inner-module-heading">
		<itera:message key="informationSystemRelease.createBusinessMapping" />
	</div>
	<div class="row-fluid">
		<div class="inner-module-body-table">
			<div class="row-fluid">
				<table class="table table-striped table-condensed tableInModule">
					...
					<thead>
						<tr>
							<th><itera:message key="global.selectedElements" /></th>
							<th>&nbsp;</th>
							<th><itera:message key="global.availableElements" /></th>
						</tr>
					</thead>
					<tbody>
						<c:if test="${typeOfBuildingBlock != 'informationSystemRelease.singular'}">
							<tr>
								<td>
									<div style="height:32px;">
										<itera:message key="informationSystemRelease.plural" />:
									</div>
								...
								<td>
									...
									<a onclick="moveSelectionLeftTopExclusive('isr', '${topLevelName}');">
										<i class="icon-arrow-left" title="<itera:message key="tooltip.add"/>" id="isr_add" ></i>
									</a>
									<br/>
									<br/>
									<a onclick="moveSelection2('isr_connected', 'isr_available');">
										<i class="icon-arrow-right" title="<itera:message key="tooltip.remove"/>" id="isr_remove"></i>
									</a>
								</td>
								<td>
									...
									<span class="pull-right">
										<itera:message key="global.filter" />:
						...
						<c:if test="${typeOfBuildingBlock != 'businessProcess.singular'}">
							<tr>
								<td>
									<div style="height:32px;">
										<itera:message key="businessProcess.plural" />:
									</div>
								...
								<td>
									...
									<a onclick="moveSelectionLeftTopExclusive('bp', '${topLevelName}');">
										<i class="icon-arrow-left" title="<itera:message key="tooltip.add"/>" id="bp_add" ></i>
									</a>
									<br/>
									<br/>
									<a onclick="moveSelection2('bp_connected', 'bp_available');">
										<i class="icon-arrow-right" title="<itera:message key="tooltip.remove"/>" id="bp_remove"></i>
									</a>
								</td>
								<td>
									<span class="pull-left" style="height:32px;">
						...
						<c:if test="${typeOfBuildingBlock != 'businessUnit.singular'}">
							<tr>
								<td>
									<div style="height:32px;">
										<itera:message key="businessUnit.plural" />:
									</div>
								...
								<td>
									...
									<a onclick="moveSelectionLeftTopExclusive('businessUnit', '${topLevelName}');">
										<i class="icon-arrow-left" title="<itera:message key="tooltip.add"/>" id="businessUnit_add" ></i>
									</a>
									<br/>
									<br/>
									<a onclick="moveSelection2('businessUnit_connected', 'businessUnit_available');">
										<i class="icon-arrow-right" title="<itera:message key="tooltip.remove"/>" id="businessUnit_remove" ></i>
									</a>
								</td>
								<td>
									<span class="pull-left" style="height:32px;">
						...
						<c:if test="${typeOfBuildingBlock != 'global.product'}">
							<tr>
								<td>
									<div style="height:32px;">
										<itera:message key="global.products" />:
									</div>
								...
								<td>
									...
									<a onclick="moveSelectionLeftTopExclusive('product', '${topLevelName}');">
										<i class="icon-arrow-left" title="<itera:message key="tooltip.add"/>" id="product_add" ></i>
									</a>
									<br/>
									<br/>
									<a onclick="moveSelection2('product_connected', 'product_available');">
										<i class="icon-arrow-right" title="<itera:message key="tooltip.remove"/>" id="product_remove" ></i>
									</a>
								</td>
								<td>
									<span class="pull-left" style="height:32px;">
						...
						<tr>
							<td colspan="2">
								<input type="button" id="reset" value="<itera:message key="button.reset" />" class="btn" 
									...
									removeOptions('product_connected');
							      	flowAction('update');" />
								&nbsp;
								<input type="button" id="add" value="<itera:message key="button.add" />" class="btn"
