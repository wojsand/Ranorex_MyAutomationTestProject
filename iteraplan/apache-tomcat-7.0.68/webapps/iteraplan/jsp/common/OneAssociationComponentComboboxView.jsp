	...
	<c:choose>
		...
		<c:when test="${component_mode != 'READ'}">
			<label class="control-label" for="${html_id}_select">
				<itera:message key="${connected_element_key}" />:
			</label>
			<div class="controls">
<%--
