...
<%-- Navigation.jsp - dropdown menu without custom dashboards --%>
				...
				<c:if test="${userContext.perms.userHasPermissionsForMenuEadata}">
					...
					<li class="dropdown ${active}" id="repository">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#repository">
							<itera:message key="menu.header.eadata" />
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu">
                            ...
                            <%-- IT Service --%>
                            <tiles:insertTemplate template="/jsp/FlowLinkPerm.jsp" flush="true">
                              <tiles:putAttribute name="this_dialog" value="ITService" />
                              <tiles:putAttribute name="title_key" value="itService.plural" />  
                              <tiles:putAttribute name="url" value="/itservice/init.do" />
                              <tiles:putAttribute name="flow_url" value="${rest_mapping}itservice" />
                            </tiles:insertTemplate>
				...
				<c:if test="${userContext.perms.userHasPermissionsForMenuReports}">
					...
					<li class="dropdown ${active}" id="reporting">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#reporting">
							<itera:message key="menu.header.reports" />
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu">
				...
				<c:if test="${userContext.perms.userHasPermissionsForMenuVisual}">
					...
					<li class="dropdown ${active}" id="diagram">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#diagram">
							<itera:message key="menu.header.visualisation" />
							<b class="caret"></b>
						</a>
						...
						<ul class="dropdown-menu">
							...
							<%-- Reactor --%>
							<c:if test="${userContext.perms.userHasFuncPermReactor == true && icLinksEnabled == true}">
								<li class="divider" />
								<li><a target="_self" href="<c:url value="/client/#/reactor" />"><itera:message key="global.reactor" /></a></li>
							</c:if>
				...
				<c:if test="${userContext.perms.userHasPermissionsForMenuMass}">
					...
					<li class="dropdown ${active}" id="bulkedit">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#bulkedit">
							<itera:message key="menu.header.massdata" />
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu">
				...
				<c:if test="${userContext.perms.userHasPermissionsForMenuGovernance}">
					...
					<li class="dropdown ${active}" id="users">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#users">
							<itera:message key="menu.header.governance" />
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu">
				...
				<c:if test="${userContext.perms.userHasPermissionsForMenuAdmin}">
					...
					<li class="dropdown ${active}" id="administration">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#administration">
							<itera:message key="menu.header.administration" />
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu">
			...
			<ul class="nav pull-right">
				<li class="dropdown" id="language">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#language">
						<itera:message key="language.select" />
						<b class="caret"></b>
					</a>
					<ul class="dropdown-menu">
						<c:forEach items="${userContext.availableLocales}" var="currentLocale" >
							<li><a href="javascript:changeLanguage('${currentLocale.abbr}'); ">${currentLocale.localizedName}</a></li>
						</c:forEach>
					</ul>
				</li>
				<li class="dropdown" id="about">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#about">
						<itera:message key="menu.header.about" />
						<b class="caret"></b>
					</a>
					<ul class="dropdown-menu">
						<li><a target="_blank" href="<c:url value="/manuals/UserGuide.pdf" />"><itera:message key="global.userguide" /></a></li>
						<li><a target="_blank" href="<c:url value="${onlineDocuLink}" />"><itera:message key="global.userguide.online" /></a></li>
						<li><a href="<c:url value="/help/show.do" />"><itera:message key="menu.header.definitions" /></a></li>
						<li><a target="_blank" href="http://www.iteraplan.de/"><itera:message key="menu.header.homepage" /></a></li>
					</ul>
				</li>
				<li class="dropdown" id="user">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="<c:out value="${link}" />"><itera:message key="menu.header.profile" /></a></li>
						<li><a id="menu.Restart" href="#" onclick="javascript:confirmEdited();"><itera:message key="navigation.reset" /></a></li>
						<li><a id="menu.Logout" href="#" onclick="confirmLogout('<c:url value="/j_iteraplan_logout" />');"><i class="icon-off"></i> 
						<itera:message key="menu.logout" />
						</a></li>
					</ul>
				</li>
			</ul>
