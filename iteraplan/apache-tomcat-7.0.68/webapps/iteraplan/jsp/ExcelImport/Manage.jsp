...
<c:choose>
	<c:when test="${functionalPermissionImport == true}">
		<div class="alert">
			...
			<itera:message key="global.excel.known_issues" />
			<ul>
				<li><itera:message key="global.excel.known_issues.templates_customization" /></li>
				<li><itera:message key="global.excel.known_issues.cycles_stop_import" /></li>
				<li><itera:message key="global.excel.limited_excel_macros" /></li>
			</ul>
		</div>
		
		<div id="ExcelDataImportModul" class="row-fluid module">
			<div class="module-heading">
				<itera:message key="global.excel_data_import" />
			</div>
			<div class="row-fluid">
								...
								<tr>
									...
									<c:choose>
										<c:when test="${(dialogMemory.wrongFileType == true)}">
											<td style="color: red"><itera:message key="global.excel.data_import_description" /></td>							
										</c:when>
										<c:otherwise>
											<td><itera:message key="global.excel.data_import_description" /></td>
										</c:otherwise>
									</c:choose>	
								</tr>
								<tr>
									<td>
										<input type="submit" style="width: 18em" class="btn"
											value="<itera:message key="button.excel.data_import"/>"
									...
									<td>
										<a  href="javascript:createHiddenField('clickedButton', '<c:out value="button.excel.download_data_temp"/>');document.forms[0].submit();"
											...
											<i class="icon-download-alt"></i>
				 							<itera:message key="button.excel.download_data_temp"/>
										</a> 
									</td>
									<td><itera:message key="global.excel.excel_data_temp_download_descr" /></td>
								</tr>
							</tbody>
						</table>
					</div>
		...
		<div id="ExcelAttributeImportModul" class="row-fluid module">
			<div class="module-heading">
				<itera:message key="global.excel_attribute_import" />
			</div>
			<div class="row-fluid">
				<div class="module-body-table">
					<div class="row-fluid">
								...
								<tr>
									...
									<c:choose>
										<c:when test="${(dialogMemory.wrongEnumFileType == true)}">
											<td style="color: red"><itera:message key="global.excel.enum_import_description" /></td>							
										</c:when>
										<c:otherwise>
											<td><itera:message key="global.excel.enum_import_description" /></td>
										</c:otherwise>
									</c:choose>	
								</tr>
								<tr>
									<td>
										<input type="submit" style="width: 18em" class="btn"
											value="<itera:message key="button.excel.enum_import"/>"
								...
								<tr>
									<td>
										<a  href="javascript:createHiddenField('clickedButton', '<c:out value="button.excel.download_enum_temp"/>');document.forms[0].submit();"
											...
											style="width: 212px" >
											<i class="icon-download-alt"></i>
				 							<itera:message key="button.excel.download_enum_temp"/>
										</a> 
									</td>
									<td><itera:message key="global.excel.excel_enum_temp_download_descr" /></td>
								</tr>
							</tbody>
						</table>
					</div>
        ...
        <div id="ExcelObjrelpermImportModul" class="row-fluid module">
			<div class="module-heading">
				<itera:message key="global.excel_objrelperm_import" />
			</div>
			<div class="row-fluid">
				<div class="module-body-table">
					<div class="row-fluid">
								...
								<tr>
									...
									<c:choose>
										<c:when test="${(dialogMemory.wrongUserFileType == true)}">
											<td style="color: red"><itera:message key="global.excel.objrelperm_import_description" /></td>							
										</c:when>
										<c:otherwise>
											<td><itera:message key="global.excel.objrelperm_import_description" /></td>
										</c:otherwise>
									</c:choose>	
								</tr>
								<tr>
									<td>
										<input type="submit" style="width: 18em" class="btn"
											value="<itera:message key="button.excel.objrelperm_import"/>"
								...
								<tr>
									<td>
										<a  href="javascript:createHiddenField('clickedButton', '<c:out value="button.excel.download_objrelperm_temp"/>');document.forms[0].submit();"
											...
											style="width: 212px" >
											<i class="icon-download-alt"></i>
				 							<itera:message key="button.excel.download_objrelperm_temp"/>
										</a> 
									</td>
									<td><itera:message key="global.excel.excel_objrelperm_temp_download_descr" /></td>
								</tr>
							</tbody>
						</table>
					</div>
