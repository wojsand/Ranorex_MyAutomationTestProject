...
<div class="${componentModeClass}">
	<c:choose>
		<c:when test="${functionalPermission == true}">
			...
			<div class="manage">
				<itera:message key="manageUser.iturm.Users" />
				<a class="cursor" href="<itera:message key="global.iturm.Link"/>"><itera:message
					key="global.iturm" /></a><itera:message key="manageUser.iturm.Users2" />
			</div>
