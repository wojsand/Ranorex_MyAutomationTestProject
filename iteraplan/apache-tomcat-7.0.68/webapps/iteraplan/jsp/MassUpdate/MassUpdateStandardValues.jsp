	...
	<thead>
		<tr>
			<th colspan="${2 + properties}">
				<itera:message key="massUpdates.exisitingAttributeValues" />
			</th>	
...
<tbody>
	<tr>
	  <td colspan="${2 + properties + (associations * 2) + (attributes * 2)}" class="helpText">
	      <itera:message key="massUpdates.help1" />
	  </td>
	</tr>
	...
	<%-- 		            	button for taking over the associations  --%>
			            	<input type="button" class="link btn" value="<itera:message key="massUpdates.takeOverStandardValue"/>"
