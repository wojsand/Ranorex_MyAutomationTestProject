...
<c:when test="${functionalPermission == true}">
    ...
    <c:when test="${timeseriesAttributesActive == true}">
		...
		<h1><itera:message key="graphicalExport.lineDiagram"/></h1>
	...
	<c:otherwise>
		<div class="alert alert-error">
			<h3><itera:message key="graphicalExport.line.Error.Title" /></h3>
			<p><itera:message key="graphicalExport.line.Error.Content" /></p>
		</div>
	</c:otherwise>
	</c:choose>	
</c:when>
