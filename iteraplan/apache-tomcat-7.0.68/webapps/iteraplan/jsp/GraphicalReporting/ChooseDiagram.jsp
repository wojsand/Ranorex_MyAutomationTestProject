	...
	<c:when test="${functionalPermission == true}">
		...
		<div class="row-fluid">
			<div class="span4" style="text-align:center;">
				...
				<p class="diagramLabel"> <a href="<c:url value="${linkLandscapeDiagram}" />" ><itera:message key="graphicalExport.landscapeDiagram" /></a> </p>
			</div>
			<div class="span4" style="text-align:center;">
				...
				<p class="diagramLabel"> <a href="<c:url value="${linkClusterDiagram}" />" ><itera:message key="graphicalExport.clusterDiagram" /></a> </p>
			</div>
			<div class="span4" style="text-align:center;">
				...
				<p class="diagramLabel"> <a href="<c:url value="${linkVbbClusterDiagram}" />" ><itera:message key="graphicalExport.vbbClusterDiagram" /></a> </p>
			</div>
		</div>
		<br/>
		<br/>
		<div class="row-fluid">
			<div class="span4" style="text-align:center;">
				...
				<p class="diagramLabel"> <a href="<c:url value="${linkInformationFlowDiagram}" />" ><itera:message key="graphicalExport.informationFlowDiagram" /></a> </p>
			</div>
			<div class="span4" style="text-align:center;">
				...
				<p class="diagramLabel"> <a href="<c:url value="${linkPortfolioDiagram}" />" ><itera:message key="graphicalExport.portfolioDiagram" /></a> </p>
			</div>
			<div class="span4" style="text-align:center;">
				...
				<p class="diagramLabel"> <a href="<c:url value="${linkMasterPlanDiagram}" />" ><itera:message key="graphicalExport.masterplanDiagram" /></a> </p>
			</div>
		</div>
		<br/>
		<br/>
		<div class="row-fluid">
			<div class="span4" style="text-align:center;">
				...
				<p class="diagramLabel"> <a href="<c:url value="${linkDashboard}" />" ><itera:message key="global.dashboard" /></a> </p>
			</div>
			<div class="span4" style="text-align:center;">
				...
				<p class="diagramLabel"> <a href="<c:url value="${linkPieBarDiagram}" />" ><itera:message key="graphicalExport.pieBarDiagram" /></a> </p>
			</div>
			<div class="span4" style="text-align:center;">
				...
				<p class="diagramLabel"> <a href="<c:url value="${linkCompositeDiagram}" />" ><itera:message key="graphicalExport.compositeDiagram" /></a> </p>
			</div>
		</div>
		<c:if test="${guiContext.timeseriesEnabled}">
			<br/>
			...
			<div class="row-fluid">
				<div class="span4" style="text-align:center;">
					...
					<p class="diagramLabel"> <a href="<c:url value="${linkLineDiagram}" />" ><itera:message key="graphicalExport.lineDiagram" /></a> </p>
				</div>
			</div>
		</c:if>
			...
			<p>			
				<a  
					...
					<i class="icon-download-alt icon-white"></i>
 					<itera:message key="graphicalExport.visioCertificate" />
				</a> 
			</p>
		</div>
	</c:when>
