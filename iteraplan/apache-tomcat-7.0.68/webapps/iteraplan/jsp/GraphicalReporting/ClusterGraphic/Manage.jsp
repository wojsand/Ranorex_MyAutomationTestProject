...
<c:when test="${functionalPermission == true}">
	...
	<tiles:insertTemplate template="/jsp/GraphicalReporting/DiagramBreadcrumb.jsp" flush="true">
		<tiles:putListAttribute name="state_keys">
			<tiles:addAttribute value="graphicalExport.cluster.breadcrumbs.chooseElements" />
			<tiles:addAttribute value="graphicalExport.cluster.breadcrumbs.configuration" />
		</tiles:putListAttribute>
		<tiles:putListAttribute name="state_events">
			<tiles:addAttribute value="goToClusterExportStep1" />
			<tiles:addAttribute value="goToClusterExportStep2" />
		</tiles:putListAttribute>
		<tiles:putAttribute name="current_state_index" value="${dialogStep - 1}" />
	</tiles:insertTemplate>
	
	<h1><itera:message key="graphicalExport.clusterDiagram" /></h1>
