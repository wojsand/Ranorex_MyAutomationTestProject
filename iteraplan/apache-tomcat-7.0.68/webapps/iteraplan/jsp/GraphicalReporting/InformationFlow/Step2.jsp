	...
	<div class="accordion-group">
		<div class="accordion-heading">
			<a class="accordion-toggle" data-toggle="collapse" data-parent="#relevantInterfacesContainer" href="#relevantInterfaces"
				...
				<itera:message key="graphicalExport.informationflow.relevantInterfaces" />
			</a>
		</div>
	    <div id="relevantInterfaces" class="accordion-body collapse">
			<div class="accordion-inner">
				<input type="button" class="link btn" onclick="flowAction('filterInterfaces');" value="<itera:message key="button.filterInterfaces"/>" />
				<c:set var="collection" value="${memBean.graphicalOptions.relevantInterfaces}"/>
				<c:if test="${collection != null}">
					<input type="button" class="link btn" onclick="flowAction('resetInterfacesFilter');" value="<itera:message key="button.reset"/>" />
					<br />
					<br />
					<tiles:insertTemplate template="/jsp/GraphicalReporting/ShowSelectedElements.jsp">
    ...
    <div class="accordion-group">
        <div class="accordion-heading">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#relevantBusinessObjectsContainer" href="#relevantBusinessObjects"
            	...
            	<itera:message key="graphicalExport.informationflow.relevantBusinessObjects" />
            </a>
		</div>
		<div id="relevantBusinessObjects" class="accordion-body collapse">
			<div class="accordion-inner">
				<input type="button" class="link btn" onclick="flowAction('filterBusinessObjects');" value="<itera:message key="button.filterBusinessObjects"/>" />
				<c:set var="collection" value="${memBean.graphicalOptions.relevantBusinessObjects}"/>
				<c:if test="${collection != null}">
					<input type="button" class="link btn" onclick="flowAction('resetBusinessObjectsFilter');" value="<itera:message key="button.reset"/>" />
					<br />
					<br />
					<tiles:insertTemplate template="/jsp/GraphicalReporting/ShowSelectedElements.jsp">
