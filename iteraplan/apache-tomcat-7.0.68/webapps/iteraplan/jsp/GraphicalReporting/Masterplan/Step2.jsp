...
<c:if test="${memBean.reportUpdated}">
	<div class="alert alert-error">
		...
		<span><itera:message key="message.report.attributeNotFound" /></span>
	</div>
</c:if>
    ...
    <div class="accordion-group">
        <div class="accordion-heading">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#level1Container" href="#level1Settings"
               ...
               <itera:message key="graphicalExport.level.1" />
            </a>
        </div>
	    <div id="level1Settings" class="accordion-body in collapse">
			<div class="accordion-inner">
				<p>
					<itera:message key="graphicalExport.masterplan.helpColor" />
				</p>
				...
				<div class="control-group">
					...
					<label class="control-label-right" for="level0.radio.attrs">
				  		<itera:message key="graphicalExport.masterplan.helpColor.attrs" />
				  	</label>
				</div>
				...
				<div class="control-group">
					...
					<label class="control-label-right" for="level0.radio.defaults">
				  		<itera:message key="graphicalExport.masterplan.helpColor.default" />
				  	</label>
				</div>
				
				<br/>
				
				<p><itera:message key="graphicalExport.masterplan.helpStep2.timespan"/></p>
				...
				<c:if test="${not empty memBean.graphicalOptions.level0Options.availableTimeLines}">
					<div style="padding-top: 1em">
						<p><itera:message key="graphicalExport.masterplan.helpStep2.chooseDateIntervals"/></p>
						<form:select path="graphicalOptions.level0Options.currentDateInterval" cssStyle="width:200px;">
			     	 	...
			     	 	<a class="link" name="addDateInterval" href="#" title="<itera:message key='tooltip.add'/>" id="addSelectedDateInterval0" onclick="flowAction('addDateInterval0');" >
							<i class="icon-plus"></i>
						</a>
					</div>
				</c:if>
	     	 	...
	     	 	<c:if test="${not empty memBean.graphicalOptions.level0Options.timelineFeatures}">
	     	 		<div style="padding-top: 1em">
			     	 	<p><itera:message key="graphicalExport.masterplan.helpStep2.selectedDateIntervals"/></p>
				...
				<div style="padding-top: 1em">
					<p>
						<itera:message key="graphicalExport.masterplan.helpStep2.sorting">
					...
					<label class="checkbox">
						...
						<itera:message key="graphicalExport.masterplan.helpStep2.sorting.option.hierarchical"/>
					</label>
				</div>
				...
				<c:if test="${memBean.graphicalOptions.level0Options.additionalCustomColumnsAllowed && not empty memBean.graphicalOptions.level0Options.availableCustomColumns}" >
					<div style="padding-top: 1em">
						<p><itera:message key="graphicalExport.masterplan.helpStep2.chooseCustomColumns"/></p>
			     		...
			     		<form:select path="graphicalOptions.level0Options.currentCustomColumn" cssStyle="width:200px;">
				   	    	...
				   	    	<c:forEach var="availableColumn" items="${customCols_array}">
				   	     		<c:choose>
				   	     			<c:when test="${!availableColumn.technicalAttribute}">
						...
						<a class="link" name="addColumn" href="#" title="<itera:message key='tooltip.add'/>" id="addSelectColumn" onclick="flowAction('addCustomColumn0');" >
							<i class="icon-plus"></i>
						</a>
					</div>
				</c:if>
				...
				<c:if test="${not empty memBean.graphicalOptions.level0Options.selectedCustomColumns}">
					<div style="padding-top: 1em">
						<p><itera:message key="graphicalExport.masterplan.helpStep2.selectedCustomColumns"/></p>
	...
	<div class="accordion-group">
		<div class="accordion-heading">
			<a class="accordion-toggle" data-toggle="collapse" data-parent="#level2Container" href="#level2Settings"
        		...
        		<itera:message key="graphicalExport.level.2" />
      		</a>
		</div>
		<div id="level2Settings" class="accordion-body collapse in">
			<div class="accordion-inner">
        		<p><itera:message key="graphicalExport.masterplan.helpStep2.relatedTypes"/></p>
				...
				<c:if test="${not empty memBean.graphicalOptions.level1Options}">
					...
					<c:if test="${memBean.graphicalOptions.level1Options.canBuildClosure}">
						...
						<label class="checkbox">
							...
							<itera:message key="graphicalExport.masterplan.helpStep2.relatedTypes.chaining" />
						</label>
						</div>
					</c:if>
				
					<div style="padding-top: 1em">
						<p><itera:message key="graphicalExport.masterplan.helpColor" /></p>
					...
					<c:if test="${not empty memBean.graphicalOptions.level1Options.availableTimeLines}">
						<div style="padding-top: 1em">
							...
							<form:select path="graphicalOptions.level1Options.currentDateInterval" cssStyle="width:200px;">
				     	 	...
				     	 	<a class="link" name="addDateInterval" href="#" title="<itera:message key='tooltip.add'/>" id="addSelectedDateInterval1" onclick="flowAction('addDateInterval1');" >
								<i class="icon-plus"></i>
							</a>
						</div>
					</c:if>
					...
					<div style="padding-top: 1em">
						<p>
							<itera:message key="graphicalExport.masterplan.helpStep2.sorting">
								<itera:param>${chosenContentType_1}</itera:param>
							</itera:message>
						</p>
					...
					<c:if test="${memBean.graphicalOptions.level1Options.additionalCustomColumnsAllowed && not empty memBean.graphicalOptions.level1Options.availableCustomColumns}">
						<div style="padding-top: 1em">
							...
							<a class="link" name="addColumn" href="#" title="<itera:message key='tooltip.add'/>" id="addSelectColumn" onclick="flowAction('addCustomColumn1');" >
								<i class="icon-plus"></i>
							</a>
						</div>
					</c:if>
	...
	<div class="accordion-group">
		<div class="accordion-heading">
			<a class="accordion-toggle" data-toggle="collapse" data-parent="#level3Container" href="#level3Settings"
        		...
        		<itera:message key="graphicalExport.level.3" />
      		</a>
		</div>
			...
			<div class="accordion-inner">
				...
				<c:if test="${not empty memBean.graphicalOptions.level2Options}">
					...
					<c:if test="${not empty memBean.graphicalOptions.level2Options.availableTimeLines}">
						<div style="padding-top: 1em">
							...
							<form:select path="graphicalOptions.level2Options.currentDateInterval" cssStyle="width:200px;">
				     	 	...
				     	 	<a class="link" name="addDateInterval" href="#" title="<itera:message key='tooltip.add'/>" id="addSelectedDateInterval2" onclick="flowAction('addDateInterval2');" >
								<i class="icon-plus"></i>
							</a>
						</div>
					</c:if>
					...
					<div style="padding-top: 1em">
						<p>
							<itera:message key="graphicalExport.masterplan.helpStep2.sorting">
								<itera:param>${chosenContentType_2}</itera:param>
							</itera:message>
						</p>
					...
					<c:if test="${memBean.graphicalOptions.level2Options.additionalCustomColumnsAllowed && not empty memBean.graphicalOptions.level2Options.availableCustomColumns}">
						<div style="padding-top: 1em">
							...
							<a class="link" name="addColumn" href="#" title="<itera:message key='tooltip.add'/>" id="addSelectColumn" onclick="flowAction('addCustomColumn2');" >
								<i class="icon-plus"></i>
							</a>
						</div>
					</c:if>
