...
<h1><itera:message key="graphicalExport.pieBarDiagram" /></h1>
...
<c:if test="${permissionCreateReports == 'true'}">
	<p class="aligned"><itera:message key="graphicalExport.pieBar.helpDiagramType" /></p>
	...
	<p class="aligned"><itera:message key="graphicalExport.pieBar.helpContentType" /></p>
