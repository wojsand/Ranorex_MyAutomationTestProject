...
<div id="SealContainer" class="modal hide fade" style="display: none;">
 	<div class="modal-header">
		...
		<h3>
			<itera:message key="seal.created.seals"/>
		</h3>
	</div>
	<div class="modal-body">
		<c:if test="${!empty allSeals}">
			<table class="table table-bordered table-striped table-condensed">
				<thead>
					<tr>
						<th><itera:message key="global.user"/></th>
						<th><itera:message key="seal.verification.date"/></th>
						<th><itera:message key="global.comments"/></th>
					</tr>
				</thead>
				<tbody>
...
<div id="SealContainerCreateNew" class="modal hide fade" style="display: none;">
	...
	<div class="modal-body">
		<itera:message key="global.comments"/>:<br/> 
	...
	<div class="modal-footer">
		...
		<button class="btn btn-primary" type="submit" name="_eventId_createSeal" id="_eventId_createSeal" onclick="$('#_eventId_createSeal').closest('form').attr('action','${flowExecutionUrl}');$('#_eventId_createSeal').closest('form').attr('onsubmit','flowActionWithID('createSeal',${id});')"><itera:message key="seal.create"/></button>
