...
<tilesx:useAttribute name="timeseriesEntryCMPath" />
<tilesx:useAttribute name="rowIndex" />
	...
	<td>
		<c:choose>
			...
			<c:when test="${timeseriesEntryCM.componentMode == 'EDIT'}">
				...
				<a id="<c:out value="${timeseriesEntryCM.htmlId}_remove" />" class="link" href="#" title="<itera:message key="tooltip.remove"/>"
			...
			<c:when test="${timeseriesEntryCM.componentMode == 'CREATE'}">
				...
				<a id="<c:out value="${timeseriesEntryCM.htmlId}_add" />" class="link" href="#" title="<itera:message key="tooltip.add"/>"
