...
<c:set var="createPermissionType">
	<itera:write name="userContext"
		property="perms.userHasBbTypeCreatePermission(${businessObject})" escapeXml="false" />
</c:set>
<tiles:insertTemplate
	template="/jsp/common/SearchFormAndResults.jsp">
	<tiles:putAttribute name="entitySearchKey" value="businessObject.search.heading" />
	<tiles:putAttribute name="entityNamePluralKey" value="businessObject.plural" />
	...
	<tiles:putAttribute name="bbTypeHtmlId" value="businessobject" />
