...
<div id="<c:out value="${htmlID}"/>Modul" class="row-fluid module">
	<div class="module-heading">
		<itera:message key="businessObject.to.informationSystemInterfaces" />
	</div>
	<div class="row-fluid">
					...
					<c:if test="${componentMode == 'CREATE'}">
						<tr>
							<td>
								...
								<span><itera:message key="businessObject.choose.interface" />
								</span></div>
							</td>
						</tr>
					</c:if>
							...
							<tr id="<c:out value="${htmlID}_new" />">
								<td colspan="5" align="left" class="borderTop">
									<a href="#" rel="tooltip" data-original-title="Hotkey: <img/> <itera:message key="jumpToInterface.tooltip"/>">
										<input type="button" value="<itera:message key="button.chooseConn" />" 
