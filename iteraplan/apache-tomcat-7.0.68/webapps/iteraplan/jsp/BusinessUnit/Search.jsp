...
<c:set var="createPermissionType">
	<itera:write name="userContext"
		property="perms.userHasBbTypeCreatePermission(${businessUnit})" escapeXml="false" />
</c:set>
<tiles:insertTemplate
	template="/jsp/common/SearchFormAndResults.jsp">
	<tiles:putAttribute name="entitySearchKey" value="businessUnit.search.heading" />
	<tiles:putAttribute name="entityNamePluralKey" value="businessUnit.plural" />
	...
	<tiles:putAttribute name="bbTypeHtmlId" value="businessunit" />
