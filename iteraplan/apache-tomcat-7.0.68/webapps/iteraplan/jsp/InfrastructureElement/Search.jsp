...
<c:set var="createPermissionType">
	<itera:write name="userContext"
		property="perms.userHasBbTypeCreatePermission(${infrastructureElement})" escapeXml="false" />
</c:set>
<tiles:insertTemplate template="/jsp/common/SearchFormAndResults.jsp">
  <tiles:putAttribute name="entitySearchKey" value="infrastructureElement.search.heading"/>
  <tiles:putAttribute name="entityNamePluralKey" value="infrastructureElement.plural"/>
  ...
  <tiles:putAttribute name="bbTypeHtmlId" value="infrastructureelement" />
