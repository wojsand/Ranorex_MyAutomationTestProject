...
<c:set var="createPermissionType">
	<itera:write name="userContext"
		property="perms.userHasBbTypeCreatePermission(${informationSystemDomain})" escapeXml="false" />
</c:set>
<tiles:insertTemplate template="/jsp/common/SearchFormAndResults.jsp">
  <tiles:putAttribute name="entitySearchKey" value="informationSystemDomain.search.heading"/>
  <tiles:putAttribute name="entityNamePluralKey" value="informationSystemDomain.plural"/>
  ...
  <tiles:putAttribute name="bbTypeHtmlId" value="informationsystemdomain" />
