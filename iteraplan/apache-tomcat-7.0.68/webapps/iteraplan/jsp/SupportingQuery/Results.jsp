	...
	<c:when test="${not empty dialogMemory.results}">
		<div id="SupportingQueryResultModul" class="row-fluid module">
			<div class="module-heading">
				<itera:message key="reports.results" /> - <itera:message key="permission.query.header" />
			</div>
			<div class="row-fluid">
						...
						<table class="table table-striped table-condensed tableInModule">
							...
							<thead>
								<tr>
									...
									<th><itera:message key="permission.query.query" /></th>
								</tr>
							</thead>
							<tbody>
