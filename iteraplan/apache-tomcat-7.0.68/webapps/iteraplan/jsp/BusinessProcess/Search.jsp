...
<c:set var="createPermissionType">
	<itera:write name="userContext"
		property="perms.userHasBbTypeCreatePermission(${businessProcess})" escapeXml="false" />
</c:set>
<tiles:insertTemplate
	template="/jsp/common/SearchFormAndResults.jsp">
	<tiles:putAttribute name="entitySearchKey" value="businessProcess.search.heading" />
	<tiles:putAttribute name="entityNamePluralKey" value="businessProcess.plural" />
	...
	<tiles:putAttribute name="bbTypeHtmlId" value="businessprocess" />
