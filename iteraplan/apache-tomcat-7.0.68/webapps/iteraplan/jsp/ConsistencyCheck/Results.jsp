    ...
    <c:forEach items="${dialogMemory.domainsResult}" var="domain" varStatus="domainStatus">
    	<div class="row-fluid module">
			<div class="module-heading">
				<itera:message key="reports.results" /> - <itera:message key="manageConsistencyReport.title" /> - <itera:message key="${domain.value}" />
			</div>
			<div class="row-fluid">
							...
							<tbody>
								...
								<c:forEach items="${dialogMemory.results[domain]}" var="result" varStatus="resultStatus">
									...
									<tr>
										...
										<td>
											<itera:message key="${result.name}" var="name" /> 
													...
													<c:when test="${parameter != null}">
														<c:choose>
															<c:when test="${parameter.localized}">
																<b><itera:message key="${parameter.value}" /></b>
															</c:when>
															<c:otherwise>
											...
											<c:choose>              
												...
												<itera:message key="manageConsistencyReport.noInconsistencies" />
												</c:when>
												<c:otherwise>
